...
interface SignUpContactModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const SignUpContactModal: React.FC<SignUpContactModalProps> = ({ isOpen, onClose }) => {
          ...
          <div className="text-center">
            ...
            <p className="text-gray-700 text-base leading-relaxed mb-6">
              ...
              <span className="font-semibold text-blue-600">
                pixelnegociosdigitais@gmail.com
              </span>{' '}
              para utilizar todos os recursos do DataScope.
            </p>
          </div>
        </div>
...
export default SignUpContactModal;